...
def run_debate(number_of_rounds, chat_history_A, chat_history_B):
    for round_num in range(number_of_rounds):
        ...
        extract_query_A = f" {response_A_cleaned}. Extract the answer. Only output the numerical answer. Do not print anything else other than the numerical answer:"
        extract_query_B = f" {response_B_cleaned}. Extract the answer. Only output the numerical answer. Do not print anything else other than the numerical answer."
